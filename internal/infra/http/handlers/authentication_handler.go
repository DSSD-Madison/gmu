...
type AuthenticationHandler struct {
	log                   logger.Logger
	authenticationManager application.AuthenticationManager
	sessionManager        application.SessionManager
}

func NewAuthenticationHandler(log logger.Logger, sessionManager application.SessionManager, authenticationManager application.AuthenticationManager) *AuthenticationHandler {
...
func (ah *AuthenticationHandler) Login(c echo.Context) error {
	...
	if err != nil {
		...
		} else if !errors.Is(err, application.ErrInvalidCredentials) {
