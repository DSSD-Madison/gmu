...
import (
	...
	"github.com/DSSD-Madison/gmu/internal/infra/database/util"
...
type UploadHandler struct {
	log            logger.Logger
	bedrockManager application.BedrockManager
	fileManager    *application.FilemanagerService
	sessionManager application.SessionManager
	db             *db.Queries
}

func NewUploadHandler(log logger.Logger, db *db.Queries, bedrockManager application.BedrockManager, fms *application.FilemanagerService, sessionManager application.SessionManager) *UploadHandler {
