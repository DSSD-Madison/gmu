...
func AddImagesToResults(results awskendra.KendraResults, c echo.Context, queries *db.Queries) (error) {
...
func ConvertToS3URIs(kendraResults awskendra.KendraResults) ([]string, error) {
	s3URIs := []string{}
