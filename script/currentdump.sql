...
COPY public.documents (id, title, abstract, region, category, publish_date, source, image_id, pdf_id, orig_link, last_modified, created_at) FROM stdin;
\.


--
-- Data for Name: keywordreference; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.keywordreference (article_id, keyword_id) FROM stdin;
\.
...
--
-- Data for Name: writtenby; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.writtenby (article_id, author_id) FROM stdin;
\.
...
GRANT SELECT ON TABLE public.authors TO insertion_script_user;
...
GRANT SELECT ON TABLE public.documents TO insertion_script_user;


--
-- Name: TABLE keywordreference; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.keywordreference TO insertion_script_user;
...
GRANT SELECT ON TABLE public.keywords TO insertion_script_user;
...
GRANT SELECT ON TABLE public.region TO insertion_script_user;


--
-- Name: TABLE writtenby; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.writtenby TO insertion_script_user;
