...
func PDFUpload(csrf string, isAuthorized bool, isMaster bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div id=\"upload-container\" class=\"relative flex items-center justify-center min-h-screen bg-gray-100 cursor-pointer dark:bg-gray-900\"><form id=\"pdf-upload-form\" action=\"/upload\" method=\"post\" enctype=\"multipart/form-data\" class=\"z-10 w-full max-w-md p-6 bg-white rounded-lg shadow-md dark:bg-gray-800\" hx-encoding=\"multipart/form-data\" hx-post=\"/upload\" hx-target=\"#upload-response\" hx-swap=\"innerHTML\"><input type=\"hidden\" name=\"_csrf\" value=\"")
			if templ_7745c5c3_Err != nil {
