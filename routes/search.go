...
func (h *SearchHandler) Search(c echo.Context) error {
	...
	component, err := selectSearchComponentTarget(req.target, results)
	if err != nil {
...
func selectSearchComponentTarget(target string, results awskendra.KendraResults) (templ.Component, error) {
	switch target {
	case "root":
		return components.Search(results), nil
	case "":
		return components.SearchHome(results), nil
